      ...
      {isSearching && (
        <div className="mb-10">
          ...
          {users.length > 0 ? (
            ...
            <div className="rounded-[12px] border border-white/10 p-12 text-center bg-white/[0.02]">
              <p className="text-white/70 text-base font-medium">No users found for &quot;{query}&quot;</p>
            </div>
          )}
        </div>
      )}
